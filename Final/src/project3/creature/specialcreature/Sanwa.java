...
public class Sanwa extends SpecialCreature{

	public Sanwa(String name,int x,int y)
	{
		super(name,x,y);
		damage = 1;
		blood = 5;
		...
		stand = Main.Constant.sanwastand;
		attack = Main.Constant.sanwaattack;
		beattack = Main.Constant.sanwabeattack;
		dead = Main.Constant.sanwadead;
