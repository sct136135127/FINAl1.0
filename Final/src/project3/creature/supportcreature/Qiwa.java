...
public class Qiwa extends SupportCreature{

	public Qiwa(String name,int x,int y)
	{
		super(name,x,y);
		blood = 3;
		maxblood = 3;
		...
		stand = Main.Constant.qiwastand;
		attack = Main.Constant.qiwaattack;
		beattack = Main.Constant.qiwabeattack;
		dead = Main.Constant.qiwadead;
