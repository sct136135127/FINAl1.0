...
public class Snake extends SupportCreature{
	...
	public Snake(String name,int x,int y)
	{
		...
		stand = Main.Constant.snakestand;
		attack = Main.Constant.snakeattack;
		beattack = Main.Constant.snakebeattack;
		dead = Main.Constant.snakedead;
